...
var CustomerGroupService = /** @class */ (function (_super) {
    ...
    function CustomerGroupService(http, apiService) {
        var _this = _super.call(this, http, uri) || this;
        _this.apiService = apiService;
        _this.cusGroups = [];
        _this.cusGroupSubject = new rxjs_1.BehaviorSubject([]);
        _this.cusGroup$ = _this.cusGroupSubject.asObservable();
        _this.apiConfig = _this.apiService.getConfig();
        uri = "" + _this.apiConfig.EmrEndPoint;
        return _this;
    }
    CustomerGroupService.prototype.getAllCustomerGroup = function () {
        var _this = this;
        ...
        return new rxjs_1.Observable(function (observable) {
            return _this.getAll().subscribe(function (data) {
                _this.cusGroups = data;
                observable.next(data);
                _this.cusGroupSubject.next(data);
                observable.complete();
            });
        });
    };
    CustomerGroupService.prototype.saveCustoemrGroup = function (data) {
