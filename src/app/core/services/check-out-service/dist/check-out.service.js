...
var CheckOutService = /** @class */ (function (_super) {
    ...
    CheckOutService.prototype.getCheckup = function () {
        this.baseURL = uri + "/setup/get-Bonus";
        return this.getAll();
    };
    CheckOutService.prototype.saveCheckup = function (checkOut) {
        this.baseURL = uri + "/setup/save-Bonus";
        this.save(checkOut);
    };
    CheckOutService.prototype.deleteCheckOut = function (id) {
