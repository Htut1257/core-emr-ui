...
var SpecialityService = /** @class */ (function (_super) {
    ...
    function SpecialityService(http, apiService) {
        var _this = _super.call(this, http, uri) || this;
        _this.apiService = apiService;
        _this._specials = [];
        _this.specialSubject = new rxjs_1.BehaviorSubject([]);
        _this.special$ = _this.specialSubject.asObservable();
        _this.apiConfig = _this.apiService.getConfig();
        uri = "" + _this.apiConfig.EmrEndPoint;
        return _this;
    }
    SpecialityService.prototype.getAllSpeciality = function () {
        var _this = this;
        this.baseURL = uri + "/opdSetup/getAllSpeciality";
        return new rxjs_1.Observable(function (observable) {
            return _this.getAll().subscribe(function (specials) {
                _this._specials = specials;
                observable.next(specials);
                _this.specialSubject.next(specials);
                observable.complete();
            });
        });
    };
    SpecialityService.prototype.getSpecialityByDescription = function (desc) {
        var httpParams = new http_1.HttpParams()
            .set('desp', desc);
        return this.getByParams(httpParams);
    };
    SpecialityService.prototype.saveSpeciality = function (model) {
        this.baseURL = uri + "/opdSetup/saveSpeciality";
        return this.save(model);
    };
    SpecialityService.prototype.deleteSpeciality = function (id) {
        var httpParams = new http_1.HttpParams()
            .set('id', id);
