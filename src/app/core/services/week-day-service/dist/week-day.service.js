...
var uri = "";
var WeekDayService = /** @class */ (function (_super) {
    __extends(WeekDayService, _super);
    function WeekDayService(http, apiService) {
    ...
    WeekDayService.prototype.getWeekDay = function () {
        var url = "" + this.apiService.getConfig().EmrEndPoint;
        this.baseURL = url + "/common/getAllDayOfWeek";
        return this.getAll();
    };
    WeekDayService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        }),
